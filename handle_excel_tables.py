...
# ====================================================
# STEP 6: Filter out rows where value is empty (optional - remove if you want blanks)
# ====================================================
# Uncomment if you want to remove empty value rows
# df_unpivot = df_unpivot.filter(col("value").trim() != "")
